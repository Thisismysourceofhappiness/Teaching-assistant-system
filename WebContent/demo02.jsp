...
4.通过JavaScript发起请求location.href="";
 ...
 通过链接发送请求
  --%>
  <a href="${pageContext.request.contextPath}/StuServlet02?method=delStu&stuId=s001">删除学生</a>
  <hr/>
<%--
 通过Ajax发送请求
  --%> 
...
$(function(){
	...
	//为id为btn的按钮绑定点击事件
	$("#btn").click(function(){
		$.post("/TestBaseServlet/StuServlet02",{"method":"updateStu","stuId":"s002"},function(data){
			console.log(data);
		});
	});
	$("#btn02").click(function(){
		//通过点击事件向服务端发起，location.href=""
		location.href="/TestBaseServlet/StuServlet02?method=findStu";
	});
